...
type LearningsServiceClient interface {
	...
	AddCourse(ctx context.Context, in *AddCourseRequest, opts ...grpc.CallOption) (*Course, error)
...
func (c *learningsServiceClient) Ping(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*PingResponse, error) {
	out := new(PingResponse)
	err := c.cc.Invoke(ctx, "/proto.learnings.v1.LearningsService/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *learningsServiceClient) AddCourse(ctx context.Context, in *AddCourseRequest, opts ...grpc.CallOption) (*Course, error) {
	out := new(Course)
	err := c.cc.Invoke(ctx, "/proto.learnings.v1.LearningsService/AddCourse", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *learningsServiceClient) ListCourses(ctx context.Context, in *ListCoursesRequest, opts ...grpc.CallOption) (LearningsService_ListCoursesClient, error) {
	stream, err := c.cc.NewStream(ctx, &LearningsService_ServiceDesc.Streams[0], "/proto.learnings.v1.LearningsService/ListCourses", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *learningsServiceListCoursesClient) Recv() (*Course, error) {
	m := new(Course)
...
type LearningsServiceServer interface {
	...
	AddCourse(context.Context, *AddCourseRequest) (*Course, error)
...
func (UnimplementedLearningsServiceServer) Ping(context.Context, *emptypb.Empty) (*PingResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Ping not implemented")
}
func (UnimplementedLearningsServiceServer) AddCourse(context.Context, *AddCourseRequest) (*Course, error) {
...
func _LearningsService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.learnings.v1.LearningsService/Ping",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LearningsServiceServer).Ping(ctx, req.(*emptypb.Empty))
	}
...
func _LearningsService_AddCourse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.learnings.v1.LearningsService/AddCourse",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (x *learningsServiceListCoursesServer) Send(m *Course) error {
...
var LearningsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.learnings.v1.LearningsService",
